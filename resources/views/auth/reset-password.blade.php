<x-guest-layout>
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-500">Defina sua nova credencial de acesso.</p>
    </div>
    ...
    <form method="POST" action="{{ route('password.store') }}" class="space-y-4">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input id="email"
                    class="bg-gray-100 border border-gray-300 text-gray-500 text-sm rounded-xl block w-full pl-10 p-3 input-with-icon cursor-not-allowed"
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input id="password"
                    ...
                    type="password" name="password" required autocomplete="new-password" placeholder="Nova senha" />
            </div>
        </div>
